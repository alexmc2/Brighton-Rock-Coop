          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button
                    className="flex w-full p-2 rounded-lg bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] text-left"
                ...
                <li className="-mx-2">
                  <button
                    className="flex w-full p-2 rounded text-left"
                    onClick={() => setFlyoutOpen(false)}
                  >
                    <Image
                      className="w-8 h-8 rounded-full mr-2"
