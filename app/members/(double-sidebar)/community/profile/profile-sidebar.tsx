...
import ProfileImage from '@/public/members/images/user-avatar-32.png';
import UserImage01 from '@/public/members/images/user-32-01.jpg';
import UserImage02 from '@/public/members/images/user-32-02.jpg';
import UserImage03 from '@/public/members/images/user-32-03.jpg';
import UserImage04 from '@/public/members/images/user-32-04.jpg';
import UserImage05 from '@/public/members/images/user-32-05.jpg';
import UserImage06 from '@/public/members/images/user-32-06.jpg';
import UserImage08 from '@/public/members/images/user-32-08.jpg';
          ...
          <div className="px-5 py-4">
            ...
            <div className="mt-4">
              ...
              <ul className="mb-6">
                <li className="-mx-2">
                  <button
                    className="w-full p-2 rounded-lg bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"
